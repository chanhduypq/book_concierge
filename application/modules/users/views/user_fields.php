...
$user_email = isset($user) ? $user->email : '';
if (isset($user) && strstr($user_email, '@twitter.com') && $user->hauth_provider == 'Twitter')
	$user_email = '';
?>
<div class="form-group<?php echo iif(form_error('email'), $errorClass); ?>">
    <label class="control-label required" for="email"><?php echo lang('bf_email'); ?></label>
    <div class="controls">
        <input class="<?php echo $controlClass; ?> form-control" type="text" id="email" name="email" value="<?php echo set_value('email',  $user_email); ?>" />
...
<div class="hidden form-group<?php echo iif(form_error('username'), $errorClass); ?>">
...
<?php endif; ?>
<?php if (!isset($user->hauth_provider) || empty($user->hauth_provider)) { ?>
