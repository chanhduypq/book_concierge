...
class Migration_Install_localization_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Localization.Settings.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Localization.Settings.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Localization.Settings.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Localization.Settings.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
