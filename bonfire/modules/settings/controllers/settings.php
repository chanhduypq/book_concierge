...
class Settings extends Admin_Controller
{
	...
	private function save_settings($extended_settings=array())
	{
		...
		$data = array(
			...
			array('name' => 'site.scrap_amazon', 'value' => (int)$this->input->post('scrap_amazon')),
			array('name' => 'site.scrap_bookdepository', 'value' => (int)$this->input->post('scrap_bookdepository')),
