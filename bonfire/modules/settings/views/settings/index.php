	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<div class="tabbable">
			<ul class="nav nav-tabs">
				...
				<!-- li>
					<a href="#scrapping" data-toggle="tab">Scrapping Settings</a>
				</li //-->
			...
			<div class="tab-content" style="padding-bottom: 9px; border-bottom: 1px solid #ddd;">
				...
				<div class="tab-pane" id="scrapping">
					<fieldset>
						<legend>Scrapping Settings</legend>

						<div class="control-group">
							<label class="control-label" for="title">Amazon US</label>
							<div class="controls">
								<select name="scrap_amazon" id="scrap_amazon">
									<option value="0" <?php echo isset($settings['site.scrap_amazon']) && $settings['site.scrap_amazon'] == 0 ? 'selected="selected"' : set_select('site.scrap_amazon', '0') ?>>API</option>
									<option value="1" <?php echo isset($settings['site.scrap_amazon']) && $settings['site.scrap_amazon'] == 1 ? 'selected="selected"' : set_select('site.scrap_amazon', '0') ?>>Scrap</option>									
								</select>
							</div>
						</div>

						<div class="control-group">
							<label class="control-label" for="title">Bookdepository.com</label>
							<div class="controls">
								<select name="scrap_bookdepository" id="scrap_bookdepository">
									<option value="0" <?php echo isset($settings['site.scrap_bookdepository']) && $settings['site.scrap_bookdepository'] == 0 ? 'selected="selected"' : set_select('site.scrap_bookdepository', '0') ?>>API</option>
									<option value="1" <?php echo isset($settings['site.scrap_bookdepository']) && $settings['site.scrap_bookdepository'] == 1 ? 'selected="selected"' : set_select('site.scrap_bookdepository', '0') ?>>Scrap</option>									
								</select>
							</div>
						</div>
					</fieldset>
